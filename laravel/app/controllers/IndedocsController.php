...
class IndedocsController extends \BaseController {
        ...
        foreach ($result->multas as $i=>$k) {
            ...
            if(count($pago_fisca) == 0)
            {
                ...
                */
                ...
                $arr_bus = array('R.S. N° ', 'R.S. N° ', 'R.S. Nº ', 'R.S.Nº ', 'RS.', 'R.S.', 'RS. ', 'R.S. ', 'RS ', 'R.S ');
                    ...
                    */                    
                    ...
                    if(count($flujos) > 0) {
                        ...
                        */
                        ...
                        $rutaDetalle['actividad'] = "PAGO DE SANCION";
    ...
    {   
        ...
        $res = file_get_contents("http://10.0.120.13:8088/srequerimiento/?fecha1=01/06/2018/&fecha2=30/06/2018");
