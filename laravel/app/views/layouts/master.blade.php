<html lang="en">
    ...
    <?php
        ...
        if(count($mensaje)==0){
            ...
            $mensaje[0]->titulo = str_replace("\r\n", "", $mensaje[0]->titulo);
            $mensaje[0]->titulo = str_replace("\r", "", $mensaje[0]->titulo);
            $mensaje[0]->titulo = str_replace("\n", "", $mensaje[0]->titulo);
            $mensaje[0]->contenido = str_replace("\r\n", "", $mensaje[0]->contenido);
            $mensaje[0]->contenido = str_replace("\r", "", $mensaje[0]->contenido);
            $mensaje[0]->contenido = str_replace("\n", "", $mensaje[0]->contenido);
        }
