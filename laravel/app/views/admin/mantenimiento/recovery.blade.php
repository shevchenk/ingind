	...
	$(document).ready(function() { 
		$.post('recovery/load',{},function(data){
			...
			for (var i = 0; i < data.length; i++) {
				...
				trd=trd+'<tr><td>'+(i+1)+'</td> <td>'+tipodoc[data[i].tipo_doc]+'</td> <td>'+data[i].numero+'</td><td>'+data[i].fecha_doc+'</td><td><span class="btn btn-primary btn-sm" onclick="showImage(\''+data[i].archivo+'\');"><i class="fa fa-image"></i></span></td><td> - </td></tr>';
